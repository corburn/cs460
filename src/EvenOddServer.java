 ...
 *
 * Usage:
 * java EvenOddServer [--threaded] <port number>
 *
 * Example:
 * java EvenOddServer --threaded 8080
 *
 *
...
/**
 * EvenOddServer implements the CS460 Project 1 EvenOddServer protocol.
 */
public class EvenOddServer implements Runnable {
     ...
     * @param clientSocket
     */
    public EvenOddServer(java.net.Socket clientSocket) {
    ...
    public static void printUsage() {
        System.err.println("Usage: java EvenOddServer [--threaded] <port number>");
        System.exit(1);
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(true) {
                ...
                if(isThreaded) {
                    (new Thread(new EvenOddServer(serverSocket.accept()))).start();
                } else {
                    new EvenOddServer(serverSocket.accept()).run();
                }
            }
